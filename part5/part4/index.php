...
if (isset($_POST['delete_reserve'])) {
    ...
    // Only delete reservations of borrowers who already borrowed
    $conn->query("
        DELETE r
        FROM reservations r
        JOIN transactions t
...
<!-- ===============================
   FAST SEARCH SCRIPT (IGNORE BORROWERS & RESERVERS)
================================ -->
<script>
const searchInput = document.getElementById("search");
const rows = Array.from(document.querySelectorAll("#bookTable tr")).slice(1);

// Cache only relevant columns: ID(0) → AVAILABLE(11), skip BORROWERS(12) & RESERVERS(13)
